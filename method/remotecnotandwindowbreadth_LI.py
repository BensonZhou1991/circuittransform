    ...
    for leaf_node in leaf_nodes:
        ...
        for swaps in possible_swap_combination:
            ...
            if draw == True:
                ...
                fig = (cir_phy_next.draw(scale=0.7, filename=None, style=None, output='mpl', interactive=False, line_length=None, plot_barriers=True, reverse_bits=False))
                fig.savefig(str(next_node)+'.pdf', format='pdf', papertype='a4')
...
#@jit
def RemoteCNOTandWindowLookAheadLI(q_phy, cir_phy, G, DG, initial_map, shortest_length_Gs, shortest_path_G, depth_lookahead, use_prune, draw=False, DiG=None, level_lookahead=None):
